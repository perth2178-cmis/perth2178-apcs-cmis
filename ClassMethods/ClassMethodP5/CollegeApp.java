public class CollegeApp
{
    public static void main(String[] args)
    {
        ...
        String school3 = new String ("Earlham"); 
         ...
         *      if it is done counter alphabetically the return value is positive. For example if the first letter of a word is A and it is being compared 
         *      to another word with a starting letter of D the result will be -3 however if D is compared to A the result will be 3.
         * b. Compare to schools that have the same first letter and a different second letter. What does compareTo() do in this case?
         *      When the first letter of the word is the same for both words compareto() moves on to the second letter and does the exact same thing to what 
         *      it would normally do by comparing the two letters by the number of letters that are in between the letters
           */
    }//end method main
